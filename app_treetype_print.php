...
require_once("include/app_treetype_variables.php");
...
$page_layouts["app_treetype_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "app.treetype" );
