...
function checkTableName($shortTName, $type=false)
{
	...
	if ("app_profile" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("app_tree" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("app_treetype" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	return false;
}
