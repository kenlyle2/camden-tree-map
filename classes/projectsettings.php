...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "app.profile" ] = array( "url" => "app_profile", "type" => 0 );
	$projectEntitiesReverse[ "app_profile" ] = "app.profile";
	$projectEntities[ "app.tree" ] = array( "url" => "app_tree", "type" => 0 );
	$projectEntitiesReverse[ "app_tree" ] = "app.tree";
	$projectEntities[ "app.treetype" ] = array( "url" => "app_treetype", "type" => 0 );
	$projectEntitiesReverse[ "app_treetype" ] = "app.treetype";
}
