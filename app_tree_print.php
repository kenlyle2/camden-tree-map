...
$layout = new TLayout("print_bootstrap", "CoralGreen", "MobileGreen");
$layout->version = 3;
...
$page_layouts["app_tree_print"] = $layout;
...
$layout = new TLayout("masterprint_bootstrap", "CoralGreen", "MobileGreen");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
...
$page_layouts["app_treetype_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "app.tree" );
