...
$layout = new TLayout("edit_bootstrap", "CoralGreen", "MobileGreen");
$layout->version = 3;
...
$page_layouts["app_treetype_edit"] = $layout;
...
$layout = new TLayout("list_bootstrap1", "CoralGreen", "MobileGreen");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
...
$page_layouts["app_treetype_list"] = $layout;
